...
import { GithubOAuthClientId } from '../environment'
...
export default () => {
  ...
  const onLoginWithGithub = () => {
    window.location.href=`https://github.com/login/oauth/authorize?client_id=${GithubOAuthClientId}&state=${window.location.origin}`;
  }
